document.addEventListener('DOMContentLoaded', function() {
    const modalButtons = document.querySelectorAll('.js-open-modal1'),
        overlay      = document.querySelector('.js-overlay-modal1'),
        closeButtons = document.querySelectorAll('.js-modal1-close');
    ...
    modalButtons.forEach(function(item){
        item.addEventListener('click', function(e) {
            ...
            document.querySelector('.modal1.active').style.display = "inline";
    ...
    overlay.addEventListener('click', function() {
        document.querySelector('.modal1.active').style.display = "none";
